...
taskName_RunSerial = "Run Serial Monitor"
...
cleanBuildDirFunction += "\t@$(foreach file, $(wildcard $(BUILD_DIR)/*), del $(file))\n"
...
defaultVsCodeSettingsFolder_UNIX = os.path.expandvars(
    "$HOME/.config/Code/User/")
defaultVsCodeSettingsFolder_OSX = os.path.expandvars(
